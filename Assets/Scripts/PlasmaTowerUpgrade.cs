...
public class PlasmaTowerUpgrade : MonoBehaviour
{
    ...
    public void BuySecondUpgrade()
    {
        if (tParamLVL1 != null && tParamLVL2 != null && tParamLVL3 != null)
        {
            tParamLVL1.cost = tParamLVL1.cost - (int)(tParamLVL1.cost * costDecreasePrc / 100.0f);
    ...
    public void BuyThirdUpgrade()
    {
        if (tParamLVL1 != null && tParamLVL2 != null && tParamLVL3 != null)
        {
            tParamLVL1.fireRate = tParamLVL1.fireRate - tParamLVL1.fireRate * fireRateDecreasePrc / 100.0f;
