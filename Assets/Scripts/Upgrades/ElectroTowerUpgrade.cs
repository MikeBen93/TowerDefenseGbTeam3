...
public class ElectroTowerUpgrade : MonoBehaviour
{
    ...
    [SerializeField] private float explosionRadiusIncrePrc;
    ...
    public void BuyThirdUpgrade()
    {
        if (tParamLVL1 != null && tParamLVL2 != null && tParamLVL3 != null)
        {
            tParamLVL1.explosionRadius = tParamLVL1.explosionRadius * ( 1 + explosionRadiusIncrePrc / 100.0f);
            tParamLVL2.explosionRadius = tParamLVL2.explosionRadius * (1 + explosionRadiusIncrePrc / 100.0f);
            tParamLVL3.explosionRadius = tParamLVL3.explosionRadius * (1 + explosionRadiusIncrePrc / 100.0f);
