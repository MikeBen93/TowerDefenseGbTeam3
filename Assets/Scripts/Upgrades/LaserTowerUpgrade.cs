...
public class LaserTowerUpgrade : MonoBehaviour
{
    ...
    [SerializeField] private float initialDamageIncreasePrc;
    ...
    public void BuyThirdUpgrade()
    {
        if (tParamLVL1 != null && tParamLVL2 != null && tParamLVL3 != null)
        {
            tParamLVL1.damageOverTime = tParamLVL1.damageOverTime * (1 + initialDamageIncreasePrc / 100.0f);
            tParamLVL2.damageOverTime = tParamLVL2.damageOverTime * (1 + initialDamageIncreasePrc / 100.0f);
            tParamLVL3.damageOverTime = tParamLVL3.damageOverTime * (1 + initialDamageIncreasePrc / 100.0f);
